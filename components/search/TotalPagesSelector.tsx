...
function SelectorItem(
  ...
  return (
    <a
      ...
      class="h-10 sm:h-6 px-3 flex items-center justify-center -translate-y-[1px]"
    >
      {value}
    </a>
  );
...
function TotalPagesSelector(props: TotalPagesSelectorProps) {
  ...
  return (
    <div class="flex gap-2 items-center text-neutral-400 text-sm font-bold">
      <span>Exibir</span>
      <div class="group relative h-10 sm:h-6 px-3 flex items-center justify-center border border-neutral-400 text-neutral-600 rounded-[2px] select-none">
